...
<form name="data_form" id="data_form" method="POST" action="{:U('databackup')}">
    ...
    <td class="td_left">{$rs.pos}</td>
    <td class="td_center"><b><<font color="#990000">LJ:block</font> <font color="#FF0000">pos="{$rs.pos}"</font> /></b></td>
    <td class="td_center"> <a href="{:U('add','id='.$rs[id])}" title="编辑该模型">编辑</a> 删除</td>
         ...
         <button class="btn02" type="button" onclick="location.href='{:U('add')}'">新增区块</button>
         </td>
         </tr>
      </tbody></table>
    </form>
